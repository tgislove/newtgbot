...
PM_START_TEXT = """
ഹായ് {}, എന്റെ പേര് {}! എന്നെ ഉപയോഗിക്കേണ്ടത് എങ്ങനെ ആണെന്നുള്ളതിൽ എന്തേലും സംശയം ഉണ്ടെങ്കിൽ /help കൊടുത്താൽ മതിയാകും... എന്നെ നിങ്ങളുടെ ഗ്രൂപ്പിൽ add ചെയ്യാനായി [ഇവിടെ click](https://telegram.me/walkytalkybot?startgroup=add) ചെയ്യുക.പിന്നീട് admin ആകുക...
...
ഞാൻ പൂർണമായും opensource ആണ്.. എന്റെ Orginal കോഡ് നിങ്ങൾക്ക് [ഇവിടെ](http://github.com/PaulSonOfLars/tgbot) കാണാവുന്നതാണ്...
