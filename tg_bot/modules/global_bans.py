...
def gban(bot: Bot, update: Update, args: List[str]):
    ...
    message.reply_text("ഇപ്പൊ ശരിയാക്കിത്തരാം... 😉"️")

    banner = update.effective_user  # type: Optional[User]
    send_to_list(bot, SUDO_USERS + SUPPORT_USERS,
                 "<b>Global Ban</b>" \
                 "\n#GBAN" \
                 "\n<b>Status:</b> <code>Gbanning</code>" \
                 "\n<b>Sudo Admin:</b> {}" \
                 "\n<b>User:</b> {}" \
                 "\n<b>ID:</b> <code>{}</code>" \
    ...
    send_to_list(bot, SUDO_USERS + SUPPORT_USERS, 
                  "{} നെ നൈസായി എല്ലാ ഗ്രൂപ്പിൽനിന്നും തട്ടിയിട്ടുണ്ട്... 😋!".format(mention_html(user_chat.id, user_chat.first_name)),
                html=True)
    message.reply_text("എല്ലാ ഗ്രൂപ്പിൽനിന്നും തട്ടിയിട്ടുണ്ട്... 😋")
