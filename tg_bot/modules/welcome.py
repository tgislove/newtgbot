...
*Admin only:*
 ...
 - /deljoin <on/off>: when someone joins, try to delete the *user* joined the group message.
...
DEL_JOINED = CommandHandler("deljoin", del_joined, pass_args=True, filters=Filters.group)
